...
do
   ...
   -- Smooth Hover Highlight Effect (Fixed to respect panel state)
    ...
    MailBtn.MouseLeave:Connect(function()
        -- Only revert to MainColor if the mail panel is closed; otherwise, stay highlighted blue
  ...
  -- Larger MailPanel positioned on the left side of the chat window (increased to 380x480)
    ...
    MailBtn.MouseButton1Click:Connect(function()
        ...
        if MailOpen then
            ...
            -- Revert back to MainColor when closed
            TweenService:Create(MailBtn, hoverTweenInfo, { BackgroundColor3 = "MainColor" }):Play()
        end
